      ...
      child: Container(
        ...
        child: SafeArea(child: LayoutBuilder(
          ...
          if (constraints.maxWidth > 1200) {
            return _DekstopHomeScreen(
              yGap: yGap,
              xGap: xGap,
              width: width,
            );
          } else {
            return _MobileTabletHomeScreen(
              yGap: yGap,
              xGap: xGap,
              width: width,
            );
...
class _MobileTabletHomeScreen extends StatelessWidget {
  final double yGap;
  final double xGap;
  final double width;

  const _MobileTabletHomeScreen({
    required this.yGap,
    required this.xGap,
    required this.width,
  });
...
class _DekstopHomeScreen extends StatelessWidget {
  final double yGap;
  final double xGap;
  final double width;

  const _DekstopHomeScreen({
    required this.yGap,
    required this.xGap,
    required this.width,
  });
      ...
      children: <Widget>[
        ...
        Expanded(
          child: MasonryGridView.count(
            crossAxisCount: width > 1240 ? 4 : 2,
            shrinkWrap: true,
            crossAxisSpacing: (xGap / 2),
            mainAxisSpacing: (yGap / 2),
            itemCount: tourismPlaceData.length,
            itemBuilder: (context, index) {
              final TourismPlaceModel placeModel = tourismPlaceData[index];
              return InkWell(
